...
//                     //     MD5Hash(inputs[i1], serial_state);
//                     //     cout << "串行:";
//                     //     for (int j = 0; j < 4; j++) {
...
//                         // for (int i1 = 0; i1 < 4; i1 += 1)
//                         // {
//                         //     cout << std::setw(8) << std::setfill('0') << hex << singleState[i1];
//                         // }
//                         // cout << endl;
//                     }
//                 }
...
//             //         batch.push_back(pw);
//             //         if (batch.size() == 4) {
//             //             string inputs[4] = {batch[0], batch[1], batch[2], batch[3]};
//             //             MD5Hash_NEON(inputs, state);
//             //             // 输出四个并行哈希结果
//             //             // for (int i1 = 0; i1 < 4; i1++) {
//             //             //     // 输出猜测和哈希
